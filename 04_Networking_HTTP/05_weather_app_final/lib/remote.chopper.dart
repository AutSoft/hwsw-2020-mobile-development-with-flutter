...
class _$WeatherService extends WeatherService {
  ...
  @override
  Future<Response<WeatherForecastListResponse>> fetchForecast(
      num latitude, num longitude,
      [String exclude = "current,minutely,hourly,alerts"]) {
    final $url = 'http://api.openweathermap.org/data/2.5/onecall';
    ...
    final $request = Request('GET', $url, client.baseUrl, parameters: $params);
    return client.send<WeatherForecastListResponse,
        WeatherForecastListResponse>($request);
  }
}
