...
class WeatherCurrentListResponse{
  final List<WeatherCurrentItem> list;

  WeatherCurrentListResponse(this.list);

  static const fromJsonFactory = _$WeatherCurrentListResponseFromJson;

  factory WeatherCurrentListResponse.fromJson(Map<String, dynamic> json) => _$WeatherCurrentListResponseFromJson(json);
  Map<String, dynamic> toJson() => _$WeatherCurrentListResponseToJson(this);
}

@JsonSerializable(createFactory: true)
class WeatherForecastListResponse{
  final List<WeatherForecastItem> daily;

  WeatherForecastListResponse(this.daily);

  static const fromJsonFactory = _$WeatherForecastListResponseFromJson;

  factory WeatherForecastListResponse.fromJson(Map<String, dynamic> json) => _$WeatherForecastListResponseFromJson(json);
